      ...
      <div className="mb-4">
        <div className="flex items-end gap-2 mb-1">
          <div className="flex items-center gap-2">
            <Image src="/market/money-2.svg" alt="Price" className="w-4 h-4" style={{ filter: 'brightness(0) saturate(100%) invert(74%) sepia(85%) saturate(353%) hue-rotate(358deg) brightness(101%) contrast(97%)' }} />
