    ...
    useEffect(() => {
      const fetchArtisanProfile = async () => {
        ...
        try {
          ...
          if (artisanInfo) {
            const transformedProfile = transformBackendProfileData(artisanData, artisanInfo, artisanAddress);
    ...
    <div>
      ...
      <div className="pt-32 px-4  flex flex-col gap-y-4 md:gap-y-8 md:px-8 xl:px-16 2xl:px-32">
        ...
        <div className="grid lg:grid-cols-2  gap-4">
          <PreviewAbout about={profile.about} />{" "}
          <PreviewSkills skills={profile.skills} />
        </div>
